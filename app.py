...
TRANSLATIONS = {
    "ru": {
        ...
        "custom.title": "Широкий выбор пиломатериалов в наличии на складе",
        "custom.text": "Доска, брус, вагонка, планкен, фанера, OSB и многое другое — всё есть на складе в Алматы. Помогаем подобрать нужный материал, размер и сорт под любую задачу.",
    ...
    "kk": {
        ...
        "custom.title": "Қоймада кең таңдау ағаш материалдары",
        "custom.text": "Тақтай, брус, вагонка, планкен, фанера, OSB және басқалары — бәрі Алматыдағы қоймада бар. Кез келген міндетке қажетті материал, өлшем мен сортты таңдауға көмектесеміз.",
